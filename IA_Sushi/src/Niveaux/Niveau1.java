...
public class Niveau1 {
	...
	// Coordonn�es des boutons du t�l�phone et du tapis de pr�paration
	...
	// On cr�e des boutons pour le t�l�phone et le tapis de pr�paration
	protected Bouton t_topping, t_free, tapis_prep, t_rice, t_nori, t_roe;
	
	// On cr�e des chemins de boutons qui correspondent aux chemins pour restocker les ingr�dients
	protected CheminBouton<Bouton> stock_rice, stock_roe, stock_nori;
	
	// Les ingr�dients utilis�s dans le niveau 1
	...
	// La liste des ingr�dients du niveau 1
	...
	public Niveau1(RobotRepere r) throws IOException {
		...
		// Initialisation des boutons du téléphone
		...
		// Initialisation des chemins pour commander les ingrédients
	 ...
	 * @return variable de type Niveau2 qui contient les nouveaux sushis + ingrédients
	 * @throws IOException
	 */
